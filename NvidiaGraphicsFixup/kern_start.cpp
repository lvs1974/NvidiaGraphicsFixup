...
PluginConfiguration ADDPR(config) {
	...
	Configuration::bootargOff,
	arrsize(Configuration::bootargOff),
	Configuration::bootargDebug,
	arrsize(Configuration::bootargDebug),
	Configuration::bootargBeta,
	arrsize(Configuration::bootargBeta),
